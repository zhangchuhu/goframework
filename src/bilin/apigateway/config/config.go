...
type AppConfig struct {
	...
	RankThriftAddrs []string `json:"rank_thrift_addrs"`
	GuardRankUrl    string   `json:"guard_rank_url"`

	//RankTargetHost          string   `json:"rank_target_host"`
	AnchorRankTargetURL     string `json:"anchor_rank_target_url"`
	ContributeRankTargetURL string `json:"contribute_rank_target_url"`
	GuardRankTargetURL      string `json:"guard_rank_target_url"`
	OnLineCountWeight       int64  `json:"on_line_count_weight"`
	LivingTimeWeight        int64  `json:"living_time_weight"`
	MaxLivingTimeWeight     int64  `json:"max_living_time_weight"`
}
