...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  i32 start( tasks)")
  fmt.Fprintln(os.Stderr, "  i32 cancel( tasks)")
...
func main() {
  ...
  case "start":
    ...
    containerStruct0 := hotline.NewDataServiceStartArgs()
    err64 := containerStruct0.ReadField1(jsProt63)
    if err64 != nil {
      Usage()
      return
    }
    argvalue0 := containerStruct0.Tasks
    value0 := argvalue0
  ...
  case "cancel":
    ...
    containerStruct0 := hotline.NewDataServiceCancelArgs()
